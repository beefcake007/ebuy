...
import com.fanye.service.CommentService;
...
public class CommentAction extends ActionSupport implements ServletRequestAware{
	...
	public String list()throws Exception{
		...
		pageCode=PageUtil.genPaginationNoParam(request.getContextPath()+"/comment_list.action", total, Integer.parseInt(page), 5);
		return SUCCESS;
	}
