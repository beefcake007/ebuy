...
<script type="text/javascript">
	...
	function deleteNotice(){
		...
		var ids=strIds.join(",");
		$.messager.confirm("系统提示","您确认要删除这<font color=red>"+selectedRows.length+"</font>个公告吗？",function(r){
			if(r){
...
<body style="margin:1px;">
	<table id="dg" title="公告管理" class="easyui-datagrid" fitColumns="true" pagination="true" rownumbers="true"
		...
		<thead>
			<tr>
				...
				<th field="content" width="400" align="center" formatter="formatContent">公告内容</th>
			</tr>
		</thead>
	</table>
	...
	<div id="dlg" class="easyui-dialog" style="width:750px;height:480px;padding:10px 20px;" closed="true" buttons="#dlg-buttons">
		<form id="fm" action="" method="post">
			<table style="border-collapse:separate; border-spacing:5px 15px;">
				...
				<tr>
					...
					<td colspan="4">
						<textarea name="notice.content" id="content" class="ckeditor"></textarea>
	...
	<div id="dlg-buttons">
		...
		<a href="javascript:closeNoticeAddDialog()" class="easyui-linkbutton" iconCls="icon-cancel">关闭</a>
	</div>
</body>
</html>