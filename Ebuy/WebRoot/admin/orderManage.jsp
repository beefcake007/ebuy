...
<body style="margin:1px;">
	<table id="dg" title="订单管理" class="easyui-datagrid" fitColumns="true" pagination="true" rownumbers="true"
		...
		<thead>
			<tr>
				...
				<th field="user.name" width="100" align="center" formatter="formatUserName">订单人用户名</th>
	...
	<div id="tb">
		...
		<div>
			...
			&nbsp;订单人用户名：&nbsp;<input type="text" id="s_userName" size="20" onkeydown="if(event.keyCode==13) searchOrder()">
	...
	<div id="dlg" class="easyui-dialog" style="width:750px; height:400px; padding:10px 20px;" closed="true" buttons="#dlg-buttons">
		...
		<table id="dg2" title="订单商品列表" class="easyui-datagrid" fitColumns="true" rownumbers="true"
