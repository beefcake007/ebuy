		...
		<form id="fm" method="post">
			<table style="border-collapse: separate; border-spacing: 5px 15px;">
				<tr>
					...
					<td colspan="4">
						<textarea rows="4" cols="50" id="content" name="comment.content" readonly="readonly"></textarea> 
					</td>
				</tr>
				<tr>
					<td valign="top">回复内容：</td>
					<td colspan="4">
						<textarea rows="4" cols="50" id="replyContent" name="comment.replyContent" class="easyui-validatebox" required="true"></textarea>
