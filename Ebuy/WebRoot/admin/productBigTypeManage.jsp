...
<script type="text/javascript">
	...
	function deleteProductBigType(){
		...
		var ids=strIds.join(",");
		$.messager.confirm("系统提示","您确认要删除这<font color=red>"+selectedRows.length+"</font>个商品大类吗？",function(r){
			if(r){
				$.post("productBigType_delete.action",{ids:ids},function(result){
					if(result.success){
						if(result.exist){
							...
							$.messager.alert("系统提示","商品大类已成功删除！");
						}
						$("#dg").datagrid("reload");
					}else{
						$.messager.alert("系统提示","商品大类删除失败！");
					}
				},"json");
			}
		});
	...
	function closeProductBigTypeAddDialog(){
		$("#dlg").dialog("close");
		resetValue();
	}
</script>
...
<body style="margin:1px;">
	<table id="dg" title="商品大类管理" class="easyui-datagrid" fitColumns="true" pagination="true" rownumbers="true"
	...
	<div id="dlg-buttons">
		...
		<a href="javascript:closeProductBigTypeAddDialog()" class="easyui-linkbutton" iconCls="icon-cancel">关闭</a>
	</div>
</body>
</html>