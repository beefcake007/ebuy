...
<script type="text/javascript">
	...
	function deleteTag(){
		...
		var ids=strIds.join(",");
		$.messager.confirm("系统提示","您确认要删除这<font color=red>"+selectedRows.length+"</font>个标签吗？",function(r){
			if(r){
...
<body style="margin:1px;">
	<table id="dg" title="标签管理" class="easyui-datagrid" fitColumns="true" pagination="true" rownumbers="true"
		...
		<form id="fm" action="" method="post">
			<table style="border-collapse:separate; border-spacing:5px 15px;">
				...
				<tr>
					<td>标签地址：</td>
					<td colspan="4">
						<input type="text" id="url" name="tag.url" class="easyui-validatebox" required="true">
					</td>
				</tr>
			</table>
		</form>
	...
	<div id="dlg-buttons">
		...
		<a href="javascript:closeTagAddDialog()" class="easyui-linkbutton" iconCls="icon-cancel">关闭</a>
	</div>
</body>
</html>