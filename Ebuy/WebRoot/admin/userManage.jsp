...
<body style="margin:1px;">
	...
	<div id="dlg" class="easyui-dialog" style="width:570px;height:320px;padding:10px 20px;" closed="true" buttons="#dlg-buttons">
		<form id="fm" action="" method="post">
			<table style="border-collapse:separate; border-spacing:5px 15px;">
				...
				<tr>
					<td>邮件：</td>
					<td><input type="text" id="email" name="user.email" class="easyui-validatebox" required="true" validType="email"></td>
					<td>&nbsp;&nbsp;&nbsp;&nbsp;</td>
					<td>联系电话：</td>
