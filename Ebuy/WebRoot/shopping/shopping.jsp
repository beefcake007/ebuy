...
$(function(){
	...
	function refreshSession(productId,count){
		$.post("shopping_updateShoppingCartItem.action",{productId:productId,count:count},function(result){
			...
			<table id="myTableProduct">
				...
				<c:forEach var="shoppingCartItem" items="${shoppingCart.shoppingCartItems }">
					<tr class="productTr">
						...
						<td class="delete"><a href="javascript:removeShopping(${shoppingCartItem.product.id })">删除</a>
						</td>
					</tr>
				</c:forEach>
			</table>
