...
<script type="text/javascript">
	...
	function deleteNews(){
		...
		var ids=strIds.join(",");
		$.messager.confirm("系统提示","您确认要删除这<font color=red>"+selectedRows.length+"</font>个新闻吗？",function(r){
			if(r){
...
<body style="margin:1px;">
	<table id="dg" title="新闻管理" class="easyui-datagrid" fitColumns="true" pagination="true" rownumbers="true"
		...
		<thead>
			<tr>
				...
				<th field="content" width="400" align="center" formatter="formatContent">新闻内容</th>
			</tr>
		</thead>
	</table>
		...
		<form id="fm" action="" method="post">
			<table style="border-collapse:separate; border-spacing:5px 15px;">
				...
				<tr>
					...
					<td colspan="4">
						<textarea name="news.content" id="content" class="ckeditor"></textarea>
	...
	<div id="dlg-buttons">
		...
		<a href="javascript:closeNewsAddDialog()" class="easyui-linkbutton" iconCls="icon-cancel">关闭</a>
	</div>
</body>
</html>